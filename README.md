 ...
 ***We are very thankful for giving us this opportunity so we could really use our brains on this project. This project helped us understand some core concepts and workflows on creating a personal assistant using several modules. We learned how to take commands and reply to those commands accordingly to the user's needs. We learned about several modules in Python for certain needs. Overall it was a great learning experience.***
